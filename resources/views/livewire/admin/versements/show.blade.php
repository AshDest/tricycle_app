    ...
    <div class="row g-3">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6"><label class="form-label text-muted small mb-1">Montant vers&eacute;</label><p class="fw-bold text-primary mb-0 fs-5">{{ number_format($versement->montant) }} FC</p></div>
                        <div class="col-md-6"><label class="form-label text-muted small mb-1">Montant attendu</label><p class="fw-medium mb-0">{{ number_format($versement->montant_attendu) }} FC</p></div>
        ...
        <div class="col-lg-4">
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between mb-2"><span class="text-muted small">Vers&eacute;</span><span class="fw-bold text-primary">{{ number_format($versement->montant) }} FC</span></div>
                    <div class="d-flex justify-content-between mb-2"><span class="text-muted small">Attendu</span><span class="fw-medium">{{ number_format($versement->montant_attendu) }} FC</span></div>
                    <hr>
                    @php $diff = $versement->montant - $versement->montant_attendu; @endphp
                    <div class="d-flex justify-content-between"><span class="text-muted small">Diff&eacute;rence</span><span class="fw-bold {{ $diff >= 0 ? 'text-success' : 'text-danger' }}">{{ $diff >= 0 ? '+' : '' }}{{ number_format($diff) }} FC</span></div>
                </div>
            </div>
