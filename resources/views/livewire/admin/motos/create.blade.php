<div>
    ...
    <div class="page-header d-flex justify-content-between align-items-center">
        <div>
            ...
            <p class="text-muted small mb-0">Enregistrer une nouvelle moto-tricycle</p>
        </div>
            ...
            <form wire:submit.prevent="save">
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" wire:model="plaque_immatriculation" class="form-control @error('plaque_immatriculation') is-invalid @enderror" placeholder="XX-XXXX-XX">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" wire:model="numero_chassis" class="form-control @error('numero_chassis') is-invalid @enderror" placeholder="Num&eacute;ro de chassis">
                    ...
                    <div class="col-md-6">
                        <label class="form-label">Motard (optionnel)</label>
