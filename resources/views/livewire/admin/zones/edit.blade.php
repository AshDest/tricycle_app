    ...
    <div class="card"><div class="card-body">
        <form wire:submit.prevent="save">
            <div class="row g-3">
                ...
                <div class="col-12 mt-4"><hr><button type="submit" class="btn btn-primary" wire:loading.attr="disabled"><span wire:loading.remove wire:target="save"><i class="bi bi-check-lg me-1"></i> Mettre &agrave; jour</span><span wire:loading wire:target="save"><span class="spinner-border spinner-border-sm me-1"></span> Mise &agrave; jour...</span></button><a href="{{ route('admin.zones.index') }}" class="btn btn-light ms-2">Annuler</a></div>
            </div>
        </form>
    </div></div>
</div>
