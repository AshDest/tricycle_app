    ...
    <div class="page-header d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4">
        <div>
            <h4 class="page-title mb-1">
                <i class="bi bi-tools me-2 text-info"></i>Prochaines Maintenances
            </h4>
            <p class="text-muted mb-0">Suivi des maintenances prévues pour les motos</p>
        </div>
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li>
                        <a class="dropdown-item" href="#" wire:click.prevent="exportExcel">
                            <i class="bi bi-file-earmark-excel me-2 text-success"></i>Export Excel (CSV)
                        </a>
                    </li>
                </ul>
            </div>
    ...
    <div class="card mb-4">
        <div class="card-body">
            <div class="row g-3 align-items-end">
                ...
                <div class="col-md-3">
                    <label class="form-label small fw-semibold">Urgence</label>
                    <select wire:model.live="filterUrgence" class="form-select">
                        <option value="">Toutes</option>
                        <option value="planifie">Avec maintenance prévue</option>
    ...
    <div class="card mt-4">
        <div class="card-body py-2">
            <div class="d-flex flex-wrap gap-4 align-items-center">
                <small class="fw-semibold">Légende:</small>
                ...
                <div class="d-flex align-items-center gap-1">
                    ...
                    <small>Planifié (> 7 jours)</small>
                </div>
                <div class="d-flex align-items-center gap-1">
                    <span class="text-muted">-</span>
                    <small>Non planifié</small>
                </div>
            </div>
        </div>
    </div>
