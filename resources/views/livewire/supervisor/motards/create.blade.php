    ...
    <div class="page-header d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4">
        <div>
            <h4 class="page-title mb-1">
                <i class="bi bi-person-plus me-2 text-primary"></i>Nouveau Motard
            </h4>
            <p class="text-muted mb-0">Enregistrer un nouveau conducteur de tricycle</p>
        </div>
                ...
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" wire:model="phone" class="form-control @error('phone') is-invalid @enderror" placeholder="+243 XXX XXX XXX">
                ...
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" wire:model="licence_numero" class="form-control @error('licence_numero') is-invalid @enderror" placeholder="Numéro de permis de conduire">
