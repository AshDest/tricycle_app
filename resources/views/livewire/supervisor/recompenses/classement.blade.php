<div>
    ...
    <div class="page-header d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('supervisor.recompenses.index') }}" class="btn btn-outline-primary">
            <i class="bi bi-award me-1"></i> Liste Récompenses
        </a>
    </div>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <div class="row g-3">
                ...
                <div class="col-md">
                    <div class="card h-100 border-{{ $index === 0 ? 'warning' : 'light' }}">
                        <div class="card-body text-center">
                            <div class="mb-2">
                                ...
                                @elseif($index === 2)
                                    <span class="badge bg-light text-dark fs-6">🥉 3e</span>
                                @else
            ...
            <table class="table table-hover mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            @if($perf->badge !== 'aucun')
                                <span class="badge" style="background-color: {{ $perf->badge_color }}">
