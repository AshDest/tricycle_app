...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    */
    Route::middleware(['role:super-admin'])->prefix('super-admin')->name('super-admin.')->group(function () {
        ...
        Route::get('/notifications-history', \App\Livewire\SuperAdmin\NotificationsHistory::class)->name('notifications-history');
    });
    ...
    */
    Route::middleware(['role:admin'])->prefix('admin')->name('admin.')->group(function () {
        ...
        Route::get('/collecteurs/soldes', \App\Livewire\Admin\Collecteurs\SoldesOverview::class)->name('collecteurs-soldes');
